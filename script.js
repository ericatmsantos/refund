...
//Capturar a entrada de valor no input para formatar o valor.
amount.oninput = () => {
...
function expenseAdd(newExpense) {
  try {
    ...
    expenseInfo.classList.add("expense_info")
...
function updateTotals() {
  try {
    ...
    for (let item = 0; item < items.length; item++) {
      ...
      if(isNaN(value)) {
        return alert("Não foi possível calcular o total. O valor não é numérico.")
      }
